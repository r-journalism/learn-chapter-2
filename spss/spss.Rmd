...
This is from the [second chapter](https://learn.r-journalism.com/enspss-files/) of [learn.r-journalism.com](https://learn.r-journalism.com/).
...
First download the data. And unzip it into the "data"" subdirectory of this working directory.

If you're working with the local data from downloaded from this course's repo, just run the lines of code below.

```{r unzip, warning=F, message=F}
temp <- tempfile()
...
4. Bring them together as one big happy data frame
